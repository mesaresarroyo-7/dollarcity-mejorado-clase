...
-- Generado automáticamente con bcrypt (10 rounds)
-- ============================================================
...
('Administrador General', 'admin@dollarcity.pe', '$2b$10$BRyJXh4yG2w8yCD2Wp5KFutfC/nuEzRjmbZu5bfyqXEPfHu9She6O', 'admin'),
('Carlos Vendedor', 'vendedor@dollarcity.pe', '$2b$10$hIStZ/kM1/lg4DfxGQl4CutL0a6GPL9LgpQm3.29QsRhNDfjj4vB6', 'vendedor'),
('María Almacenera', 'almacen@dollarcity.pe', '$2b$10$LI6jBEfJjnYlsi/hv6gOE.gicFLaH5s0jBEBvgHX6T.cBKqQeyHVe', 'almacenero');
